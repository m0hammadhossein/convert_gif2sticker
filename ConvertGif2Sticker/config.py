...
لطفا گیف خود را ارسال کنید.

<b>نکته : زمان گیف ارسالی شما نباید بیشتر از ۳ ثانیه باشد</b>''',
        'wait': 'برای ارسال گیف بعدی باید {} ثانیه صبر کنید',
        'wait_for_convert': 'لطفا صبر کنید...',
        'error_gif_duration': 'گیف شما نباید بیشتر از 3 ثانیه باشد',
        'already_blocked': 'کاربر مورد نظر پیدا نشد یا قبلا مسدود شده است',
        'blocked': 'کاربر مورد نظر مسدود شد',
        'block': 'شما از ربات مسدود شده اید',
        'already_unblocked': 'کاربر مورد نظر پیدا نشد یا قبلاً از لیست کاربران مسدود شده حذف شده است',
        'unblocked': 'کاربر مورد نظر از لیست کاربران مسدود شده حذف شد',
        'unblock': 'شما از لیست کاربران مسدود شده حذف شده اید',
        'error_channel': 'این شناسه متعلق به یک کانال نیست',
        'add_channel': 'با موفقیت به لیست کانال ها اضافه شد',
        'not_found_channel': 'کانالی با این شناسه پیدا نشد',
        'exists_channel': 'این کانال در حال حاضر در لیست کانال ها موجود است',
